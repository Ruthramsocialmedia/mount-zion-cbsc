(function () {
    ...
    const menuCategories = [
        ...
        },
        {
            label: "Services",
            items: [
                { icon: "fa-credit-card", label: "Payment", id: "menu-payment", url: "https://payments.billdesk.com/bdcollect/pay?p1=4833&p2=1" },
                { icon: "fa-user-graduate", label: "Student Login", id: "menu-student-login", url: "https://ssolive.myclassboard.com/Account/Login?ReturnUrl=%2Fconnect%2Fauthorize%2Fcallback%3Fclient_id%3DEP5WI6IH8T1V0Q5FX0OR%26redirect_uri%3Dhttps%253A%252F%252Fmountzion.myclassboard.com%252Fsso%252FCallback%26response_type%3Dcode%26scope%3Dopenid%2520profile%2520offline_access" }
            ]
        },
        {
            label: "Admissions",
            items: [
                { icon: "fa-file-lines", label: "Admission & Prospectus", id: "menu-admission", url: "https://mountzionschools.com/cbse/pros/pros.html" }
            ]
        },
        {
            label: "Facilities",
            items: [
                { icon: "fa-building", label: "Infrastructure", id: "menu-infrastructure", url: "https://mountzionschools.com/cbse/infrastructure.html" },
                { icon: "fa-bed", label: "Hostel Facility", id: "menu-hostel", url: "https://mountzionschools.com/cbse/hostel.html" },
                { icon: "fa-futbol", label: "Sports Facility", id: "menu-sports", url: "https://mountzionschools.com/cbse/sports.html" },
                { icon: "fa-bus", label: "Transport", id: "menu-transport", url: "https://mountzionschools.com/cbse/transport.html" },
                { icon: "fa-flask", label: "Lab", id: "menu-lab", url: "https://mountzionschools.com/cbse/lab.html" },
                { icon: "fa-book-open", label: "Library", id: "menu-library", url: "https://mountzionschools.com/cbse/library.html" }
            ]
        },
        {
            label: "Information",
            items: [
                ...
                { icon: "fa-circle-info", label: "Info", id: "menu-visitor", url: "https://mountzionschools.com/cbse/aboutus.html" }
            ]
        },
        {
            label: "Connect",
