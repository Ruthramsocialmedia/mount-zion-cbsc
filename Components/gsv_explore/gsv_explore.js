(function () {
    ...
    overlay.innerHTML = `
        <div class="gsv-modal">
            ...
            <div class="gsv-footer-premium">
                ...
                <span class="gsv-footer-text">Mount Zion School - CBSC Street View</span>
            </div>
        </div>
    `;
    ...
    document.getElementById('gsv-ab-direction').addEventListener('click', () => {
        if (!currentGsvItem) return;
        const dest = encodeURIComponent(currentGsvItem.label + ', Mount Zion International School - CBSC');
