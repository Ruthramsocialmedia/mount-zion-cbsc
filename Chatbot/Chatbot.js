...
(function () {
  ...
  style.href = "Chatbot/css/style.css";
  ...
  chatToggle.setAttribute("aria-label", "Open ZIA Chatbot");
  // Hidden — dock widget now handles the visible trigger
  chatToggle.style.display = "none";

  chatToggle.innerHTML = `
    <img src="Chatbot/assets/MZHSS.png" alt="Chat" class="chat-icon"/>
  ...
  chatWidget.innerHTML = `
    <header class="chat-header">
      <div class="chat-title">
        <div class="chat-avatar">
          <img src="Chatbot/assets/MZHSS.png" alt="Mount Zion International School - CBSC" width="40" height="40"/>
        </div>
    ...
    <form id="chat-form" class="chat-form">
      ...
      <p class="chat-hint">Try: "admission" or "how to reach Mount Zion International School - CBSC"</p>
    </form>
  `;
  ...
  (async function loadAllScripts() {
    ...
    await loadScript("Chatbot/js/config.js");    // ChatbotConfig
    await loadScript("Chatbot/js/sound.js");     // Sound controls
    await loadScript("Chatbot/js/ui.js");        // Chat UI system
    await loadScript("Chatbot/js/vista.js");     // Vista + loads panoramas/projects
    await loadScript("Chatbot/js/chat.js");      // AI + backend + intent engine
