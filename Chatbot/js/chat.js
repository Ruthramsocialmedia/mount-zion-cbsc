  ...
  async function handleUserMessage(text) {
    ...
    if (isGreeting(trimmed)) {
      ...
      window.ChatUI.typeBotMessage(
        "Hi, this is ZIA, your Mount Zion International School - CBSC assistant. How can I help you today?",
        22
      );
      return;
    }
    ...
    if (isNameQuery(trimmed)) {
      ...
      window.ChatUI.typeBotMessage(
        "I'm ZIA, your Mount Zion International School - CBSC assistant. Here to guide you.",
        22
      );
      return;
    }
